#!/bin/bash
# example: bash call_variant_WGS_new.sh COMMANDER23.batch.txt COMMANDER23.GRCh38.bed /lustre03/project/6004655/COMMUN/runs/lang/Commander/data/Filter_ID.txt genes/COMMANDER23_QC
batch=$1
bed_file_local=$2
sample_file_local=$3
